  ...
  <div class="w-full" style="width: 100%">
    ...
    <div class="odd-movie mt-8">
      <div class="d-flex justify-space-between">
        ...
        <p class="hover-under-line">Xem tất cả</p>
      </div>
      <v-divider></v-divider>
      <v-container>
        <v-row>
          <v-col  v-for="movie of movies" :key="movie.id" :cols="$vuetify.breakpoint.name == 'xs' ? '6 ' : '3'">
            <v-img
              :src="movie.imagelink"
              max-height="100%"
              max-width="100%"
...
export default {
  async asyncData() {
    ...
    return { typeMovies: typeMovie.data, nationalMovies: nationalMovie.data , movies: movies.data.movies}
  },
  data: () => ({
